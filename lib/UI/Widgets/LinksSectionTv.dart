...
class links_section_tv extends StatelessWidget {
  links_section_tv({Key key, this.title, this.link}) : super(key: key);
  final title, link;
  bool proof;
                              ...
                              IconsOutlineButton(
                                onPressed: () {
                                  ...
                                  _launchInBrowser(getLink(
                                      Constraints.linklistTv[index].link,
                                      link,
                                      Constraints.linklistTv[index].name));
                                },
                                text: 'I understand',
